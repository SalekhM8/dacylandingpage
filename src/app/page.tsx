    ...
    <section className="relative min-h-screen overflow-hidden pt-20 bg-[#1A2634]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-8 lg:pt-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-start">
          ...
          <div>
            <h1 className="font-display text-[2.8rem] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[72px] text-[#3EB489] leading-[0.95] mb-6 tracking-[-0.04em]" style={{ fontWeight: 900 }}>
              Your restaurant&apos;s
              <br />
              unfair advantage.
          </h1>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                href="https://www.linkedin.com/company/dacyai"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-[#3EB489]/20 rounded-lg flex items-center justify-center transition-colors group"
              >
                <Linkedin className="w-5 h-5 text-white/50 group-hover:text-[#3EB489]" />
              </a>
              <a
                href="https://www.instagram.com/dacy.ai"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-[#3EB489]/20 rounded-lg flex items-center justify-center transition-colors group"
              >
                <Instagram className="w-5 h-5 text-white/50 group-hover:text-[#3EB489]" />
              </a>
              <a
                href="https://www.tiktok.com/@dacy.ai"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 hover:bg-[#3EB489]/20 rounded-lg flex items-center justify-center transition-colors group"
              >
                <svg className="w-5 h-5 text-white/50 group-hover:text-[#3EB489]" fill="currentColor" viewBox="0 0 24 24">
